...
class SplashModel implements SplashContract.Model {
    ...
    public Observable<Object> someDataModel(String arg1, String arg2) {
        ...
        return DemoRetrofitClient.getInstance().getApi(DemoApiInterface.class).postSample(someDataMap);
    }
    ...
    public Observable<Void> registerModel(String accountName, String password) {
        return DemoRetrofitClient.getInstance().getApi(DemoApiInterface.class).register(accountName, password);
    }
}
